...
public class CreateBoard : MonoBehaviour
{
    ...
    void PlantTree()
    {
        ...
        // In the if I am subtracting dirtBB and playerBB to get the the dirtBBs 
    ...
    void CalculateScore()
    {
        int dirtScore = CellCount(playerBB & dirtBB) * 10;
        int desertScore = CellCount(playerBB & desertBB) * 2;
        int calculatedScore = dirtScore + desertScore;

        score.text = "Score: " + calculatedScore;
    }
